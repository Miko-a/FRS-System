        ...
        <form action="{{ route('user.update', $user->login_id) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $namaLengkap }}" readonly
                ...
                <div>
                    ...
                    <input type="password" name="password" value="{{ old('email', $user->email) }}" class="w-full rounded-lg bg-gray-800 border border-gray-700 px-3 py-2 text-gray-100">
                ...
                <div class="flex justify-end gap-3 pt-4">
                    <a href="{{ route('user.index') }}" class="px-5 py-2.5 rounded-lg bg-gray-700 hover:bg-gray-600 text-gray-200 font-medium transition duration-200">Batalkan</a>
