...
<main class="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-end mb-6">
        <a href="<?php echo e(route('matakuliah.create')); ?>" 
           class="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-md">Tambah Mata Kuliah</a>
    </div>
            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 space-x-2">
                        <a href="<?php echo e(route('matakuliah.show', $matkul)); ?>" 
                           class="px-3 py-1 bg-blue-600 hover:bg-blue-500 text-white rounded-md text-sm">Detail</a>
                        <a href="<?php echo e(route('matakuliah.edit', $matkul->kode_mk)); ?>" 
                           class="px-3 py-1 bg-yellow-600 hover:bg-yellow-500 text-white rounded-md text-sm">Edit</a>
                        <form action="<?php echo e(route('matakuliah.destroy', $matkul)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\acer\FRS-System\frs-system\resources\views/matakuliah/index.blade.php ENDPATH**/ ?>