        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="<?php echo e(route('mahasiswa.informasiKelas')); ?>" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">List Kelas</a>
    ...
    <main class="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <div class="overflow-x-auto bg-gray-800/60 p-6 rounded-2xl shadow-xl">
            <table class="min-w-full divide-y divide-gray-700 text-gray-100">
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <form action="<?php echo e(route('mahasiswa.dropMatkul')); ?>" method="POST" class="drop-form">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="kelas_id" value="<?php echo e($k->kelas_id); ?>">
            ...
            <div class="mt-8 flex justify-center">
                <a href="<?php echo e(route('mahasiswa.dashboard')); ?>" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 rounded-md text-white transition">
...
</html><?php /**PATH C:\Users\acer\FRS-System\frs-system\resources\views/mahasiswa/informasiKelas.blade.php ENDPATH**/ ?>