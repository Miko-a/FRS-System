...
<div class="max-w-lg mx-auto mt-20 bg-gray-800/70 p-8 rounded-2xl shadow-xl border border-gray-700">
    ...
    <form action="<?php echo e(route('user.storeAkun')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\iss5i\Documents\FRS-System\frs-system\resources\views/user/createAkun.blade.php ENDPATH**/ ?>