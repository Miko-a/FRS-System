    ...
    <div class="bg-gray-800/60 p-8 rounded-2xl shadow-xl space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <p class="text-white font-medium"><?php echo e($dosen->nip); ?></p>
            </div>
            <div>
                <p class="text-gray-400">Nama Lengkap</p>
                <p class="text-white font-medium"><?php echo e($dosen->nama); ?></p>
            </div>
            <div>
                <p class="text-gray-400">Program Studi</p>
                <p class="text-white font-medium"><?php echo e($dosen->program_studi); ?></p>
            </div>

            <?php elseif($user->role === 'mahasiswa'): ?>
            <div>
                <p class="text-gray-400">NRP</p>
                <p class="text-white font-medium"><?php echo e($mahasiswa->nrp); ?></p>
            </div>

            <div>
                <p class="text-gray-400">Nama Lengkap</p>
                <p class="text-white font-medium"><?php echo e($mahasiswa->nama); ?></p>
            </div>

            <div>
                <p class="text-gray-400">Angkatan</p>
                <p class="text-white font-medium"><?php echo e($mahasiswa->angkatan); ?></p>
            </div>

            <div>
                <p class="text-gray-400">Program Studi</p>
                <p class="text-white font-medium"><?php echo e($mahasiswa->program_studi); ?></p>
            </div>

            <div>
                <p class="text-gray-400">Semester</p>
                <p class="text-white font-medium"><?php echo e($mahasiswa->semester); ?></p>
            </div>
        ...
        <div class="flex justify-end">
            <a href="<?php echo e(route('user.index')); ?>" class="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-md">Kembali</a>
        </div>
...
<?php /**PATH C:\Users\iss5i\Documents\FRS-System\frs-system\resources\views/user/show.blade.php ENDPATH**/ ?>