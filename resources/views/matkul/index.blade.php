          ...
          <div class="shrink-0">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="{{ route('matkul.index') }}" class="rounded-md bg-gray-950/50  px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Informasi Kelas</a>
            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 space-x-2">
                        <a href="{{ route('matkul.show', $matkul) }}" 
