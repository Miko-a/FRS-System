...
<body class="h-full">
          ...
          <div class="shrink-0">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    <a href="<?php echo e(route('dosen.dashboard')); ?>" aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Dashboard</a>

                    <a href="<?php echo e(route('matkul.index')); ?>" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Informasi Kelas</a>
    ...
    <main>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            ...
            <a href="<?php echo e(route('matkul.index')); ?>" 
            ...
            <a href="<?php echo e(route('matkul.show', 1)); ?>" 
                class="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-md transition">
                Lihat Sekarang
            </a>
            </div>
...
</html><?php /**PATH C:\Users\iss5i\Documents\lbebackup\resources\views/dosen/dashboard.blade.php ENDPATH**/ ?>