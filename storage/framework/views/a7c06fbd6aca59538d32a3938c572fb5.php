            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block ml-10 flex items-baseline space-x-4">
                     <a href="<?php echo e(route ('admin.dashboard')); ?>" aria-current="page" class="rounded-md px-3 py-2 text-sm font-medium text-white">Dashboard</a>
                        <a href="<?php echo e(route('matkul.index')); ?>" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">List Mata Kuliah</a>
...
<main class="max-w-3xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
    <div class="bg-gray-800/60 p-8 rounded-2xl shadow-xl space-y-6">
        ...
        <div class="flex justify-end">
            <a href="<?php echo e(route('matkul.index')); ?>" class="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-md">Kembali</a>
        </div>
...
<?php /**PATH C:\Users\iss5i\Documents\lbebackup\resources\views/matkul/show.blade.php ENDPATH**/ ?>