        ...
        <form action="<?php echo e(route('user.update', $user->login_id)); ?>" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" value="<?php echo e($namaLengkap); ?>" readonly
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="password" name="password" value="<?php echo e(old('email', $user->email)); ?>" class="w-full rounded-lg bg-gray-800 border border-gray-700 px-3 py-2 text-gray-100">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="role" class="w-full rounded-lg bg-gray-800 border border-gray-700 px-3 py-2 text-gray-100">
                        ...
                        <option value="dosen" <?php echo e($user->role=='dosen' ? 'selected' : ''); ?>>Dosen</option>
                        <option value="mahasiswa" <?php echo e($user->role=='mahasiswa' ? 'selected' : ''); ?>>Mahasiswa</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end gap-3 pt-4">
                    <a href="<?php echo e(route('user.index')); ?>" class="px-5 py-2.5 rounded-lg bg-gray-700 hover:bg-gray-600 text-gray-200 font-medium transition duration-200">Batalkan</a>
...
<?php /**PATH C:\Users\iss5i\Documents\FRS-System\frs-system\resources\views/user/edit.blade.php ENDPATH**/ ?>